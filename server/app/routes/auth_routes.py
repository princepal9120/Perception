...
@router.post("/token/refresh", response_model=TokenResponse, responses={401: {"model": ErrorResponse}})
...
async def logout(current_user: User = Depends(get_current_active_user)):
    ...
    return SuccessResponse(message="Logged out successfully", data={"user_id": current_user.id})
