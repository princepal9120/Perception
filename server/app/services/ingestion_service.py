    ...
    def __init__(
        ...
        try:
            ...
            try:
                ...
                raise DocumentPortalException(
                    "Failed to connect to Pinecone. Check if PINECONE_API_KEY is set correctly.", e
                ) from e

            log.info(
                "ChatIngestor initialized with Pinecone",
        ...
        *,
        ...
        try:
            ...
            if not docs:
                ...
                vectorstore = PineconeVectorStore(index=self.index, embedding=embeddings, namespace=self.session_id)
                return vectorstore.as_retriever(
                    search_type=search_type, search_kwargs={"k": k, "fetch_k": fetch_k, "lambda_mult": lambda_mult}
                )
            ...
            vectorstore = PineconeVectorStore.from_documents(
                documents=chunks, embedding=embeddings, index_name=self.index_name, namespace=self.session_id
            )
